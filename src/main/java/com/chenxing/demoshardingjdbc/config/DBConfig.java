...
public class DBConfig {
	...
	public MyJdbcTemplate getJdbcTemplatePrimary1(@Qualifier("dataSourcep1") DataSource dataSource) {
	...
	public MyJdbcTemplate getJdbcTemplatePrimary2(@Qualifier("dataSourcep2") DataSource dataSource) {
		return new MyJdbcTemplate(dataSource);
	}
	...
	public MyJdbcTemplate getJdbcTemplatePrimary3(@Qualifier("dataSourcep3") DataSource dataSource) {
		return new MyJdbcTemplate(dataSource);
	}
}
